Informatics IIb - Assignment 4
==============================

> This is the public repo for the assignment 4 at Informatics IIb as a reference.
...
* As a starting point you should clone this repository on its initial state through:
  ...
  ```shell
  > git clone git://github.com/rkoch/uzh-inf02b-a4.git
  > cd uzh-inf02b-a4
  ...
  [Download Tarball of Tag `initial`](https://github.com/rkoch/uzh-inf02b-a4/archive/initial.zip)
